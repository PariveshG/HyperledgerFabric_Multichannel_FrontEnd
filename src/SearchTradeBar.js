...
export default class SearchTradeBar extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
axios.get(`http://54.180.32.186:4000/channels/channel12/chaincodes/mycc?peer=peer0.${this.props.party.toLowerCase()}.example.com&fcn=query&args=%5B%22${this.state.currentText}%22%5D&username=${this.props.name}&orgName=${this.props.party}`,
    ).then(response => {
